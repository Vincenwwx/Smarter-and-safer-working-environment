(define (domain office)
  ...
  ; automatic brightness control in the office
   ...
   (:action noperson_wait_humidifieroff
        :parameters (?h - humidifer ?r - room ?m - message)
        :precondition (or (not(off2 ?h)) (<(occupy ?r) (occupy_limit)))
